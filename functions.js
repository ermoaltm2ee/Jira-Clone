...
describe("Time-tracking functionality tests of the issue", () => {
  ...
  it("Should add, update and remove estimated time in the issue", () => {
    ...
    cy.contains(`${estimatedTimeUpdated}${estimatedTimeExpectedText}`).should(
      "be.visible"
    );
  ...
  it("Should add and remove logged time values", () => {
    ...
    cy.contains(`${remainingTime}${remainingTimeExpectedText}`).should(
      "be.visible"
    );
    cy.contains(`${estimatedTime}${estimatedTimeExpectedText}`).should(
      "not.exist"
    ...
    cy.contains(`${loggedTimeUpdated}${loggedTimeExpectedText}`).should(
      "be.visible"
    );
    cy.contains(`${remainingTimeUpdated}${remainingTimeExpectedText}`).should(
      "be.visible"
    );
    cy.contains(`${estimatedTime}${estimatedTimeExpectedText}`).should(
      "not.exist"
